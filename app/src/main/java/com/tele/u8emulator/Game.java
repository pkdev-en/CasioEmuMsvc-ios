...
// import io.sentry.Sentry; // Not imported: no `io.sentry:sentry-android` dependency
// is declared in app/build.gradle's dependencies{} block, and the Sentry Gradle
// plugin itself is commented out there too, so this import fails to resolve as-is.
// Re-enable both together (plugin + dependency) before uncommenting this.
