...
// into the contained app instead of LiveContainer's own app list. See
// Ext/ShortcutLaunch.h: casioemu.cpp needs this same check while a
// *different* model is already running, see the comment at the top of that
// header.
