...
inline const ImWchar* GetGlobalRanges() {
    static const ImWchar ranges[] = {
        ...
        // General punctuation, symbols, arrows, geometric shapes.
        // Covers U+23F8 (⏸ pause) and U+25B6 (▶ play/run) used by
        // RenderStatusBar's run/pause indicator — these previously fell in
        // the gap between 0x206F and 0x3000 and rendered as missing glyphs.
        0x2000, 0x2BFF,
