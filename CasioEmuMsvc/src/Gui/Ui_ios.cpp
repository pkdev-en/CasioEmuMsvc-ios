// ============================================================================
// Ui_ios.cpp — UI loop CHỈ dành cho iOS (SINGLE_WINDOW + touch toolbar)
// File này KHÔNG được compile trên Windows / macOS / Linux / Android.
// CMakeLists.txt chọn giữa Ui.cpp (stable) và Ui_ios.cpp (iOS) tùy platform.
// ============================================================================
#ifndef __IOS__
#error "Ui_ios.cpp chỉ được compile khi target là iOS. Kiểm tra lại CMakeLists.txt."
#endif
...
static const float TOOLBAR_TAB_W          = 28.0f;
...
void RenderDebuggerToolbar() {
    ...
    // ── iOS: floating draggable toolbar ───────────────────────────────────────
