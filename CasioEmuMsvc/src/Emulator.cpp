...
namespace casioemu {
        ...
        void Emulator::Frame() {
                ...
                if (!calculator_as_tab.load()) {
                        ...
                        SDL_RenderClear(renderer);
#ifdef __IOS__
                        // Render into safe area to avoid notch, Dynamic Island and home indicator
                        float sT = getSafeTop();
                        ...
                        auto wf2 = (double)safeW / render_target_w;
                        auto hf2 = (double)safeH / render_target_h;
                        auto uf2 = std::min(wf2, hf2);
                        SDL_Rect safeDest{};
                        safeDest.w = (int)(render_target_w * uf2);
                        safeDest.h = (int)(render_target_h * uf2);
